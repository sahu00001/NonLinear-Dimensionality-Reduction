...
encoding_dim = 105  # Manually setting the encoding dimension
encoder_neurons = [548, 1710]  # Encoder: decreasing number of neurons
decoder_neurons = [247, 1348, 574]  # Decoder: increasing number of neurons
epochs = 5000  # Number of epochs
batch_size = 91  # Batch size
learning_rate = 0.000035988530827777734  # Custom learning rate
...
# Save metrics to CSV
output_csv_file = '5000tanhtrial56.csv'
...
model_save_path = '5000tanhtrial56.h5'
