...
def create_autoencoder(input_dim, encoding_dim, encoder_neurons, decoder_neurons):
    ...
    for neuron in encoder_neurons:  # Define encoder structure
        x = Dense(neuron, activation=shifted_selu)(x)

    # Latent space layer
    latent_space = Dense(encoding_dim, activation=shifted_selu)(x)
...
encoder_neurons = [800, 1572]  # Encoder: decreasing number of neurons
decoder_neurons = [1407, 489]  # Decoder: increasing number of neurons
epochs = 5000  # Number of epochs
batch_size = 24  # Batch size
learning_rate = 0.0000695746564826733  # Custom learning rate
...
autoencoder.save("selutrial54.h5")
...
# Save metrics to CSV
output_csv_file = 'selutrial54.csv'
