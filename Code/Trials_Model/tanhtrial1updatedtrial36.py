...
encoding_dim = 133  # Manually setting the encoding dimension
encoder_neurons = [1541, 1833, 340, 905]  # Encoder: decreasing number of neurons
decoder_neurons = [516, 1898]  # Decoder: increasing number of neurons
epochs = 5000  # Number of epochs
batch_size = 98  # Batch size
learning_rate = 0.0000288765159766277  # Custom learning rate
...
autoencoder.save("tanhtrial1updatedtrial36.h5")
...
# Save metrics to CSV
output_csv_file = 'tanhtrial1updatedtrial36.csv'
