...
#SBATCH --ntasks=1
#SBATCH --mem=62G
#SBATCH --output=jobname_%J_stdouttanhtrial1updatedtrial25.txt
#SBATCH --error=jobname_%J_stderrtanhtrial1updatedtrial25.txt
...
python $HOME/tanhtrial1updatedtrial25.py
