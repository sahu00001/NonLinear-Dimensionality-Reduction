...
encoder_neurons = [1185]  # Encoder: decreasing number of neurons
decoder_neurons = [2454, 437, 440, 703]  # Decoder: increasing number of neurons
epochs = 5000  # Number of epochs
batch_size = 90  # Batch size
learning_rate = 0.0001782070375460867  # Custom learning rate
...
autoencoder.save("softplustrial21.h5")
...
# Save metrics to CSV
output_csv_file = 'softplustrial21.csv'
