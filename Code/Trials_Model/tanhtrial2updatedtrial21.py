...
encoding_dim = 115  # Manually setting the encoding dimension
encoder_neurons = [1487]  # Encoder: decreasing number of neurons
decoder_neurons = [1738]  # Decoder: increasing number of neurons
epochs = 5000  # Number of epochs
batch_size = 94  # Batch size
learning_rate = 0.00005093753231338361  # Custom learning rate
...
autoencoder.save("tanhtrial2updatedtrial21.h5")
...
# Save metrics to CSV
output_csv_file = 'tanhtrial2updatedtrial21.csv'
