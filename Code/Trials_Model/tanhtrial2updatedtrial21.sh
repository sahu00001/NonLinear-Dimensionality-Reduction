...
#SBATCH --ntasks=1
#SBATCH --mem=62G
#SBATCH --output=jobname_%J_stdouttanhtrial2updatedtrial21.txt
#SBATCH --error=jobname_%J_stderrtanhtrial2updatedtrial21.txt
...
python $HOME/tanhtrial2updatedtrial21.py
