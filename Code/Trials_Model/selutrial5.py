...
encoder_neurons = [1266]  # Encoder: decreasing number of neurons
decoder_neurons = [1151]  # Decoder: increasing number of neurons
epochs = 5000  # Number of epochs
batch_size = 42  # Batch size
learning_rate = 0.04409964705416618  # Custom learning rate
...
autoencoder.save("selutrial5.h5")
...
# Save metrics to CSV
output_csv_file = 'selutrial5.csv'
