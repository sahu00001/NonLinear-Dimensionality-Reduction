...
#SBATCH --ntasks=1
#SBATCH --mem=62G
#SBATCH --output=jobname_%J_stdoutsigmoidtria1updatedtrial15.txt
#SBATCH --error=jobname_%J_stderrsigmoidtria1updatedtrial15.txt
...
python $HOME/sigmoidtria1updatedtrial15.py
