...
#SBATCH --ntasks=1
#SBATCH --mem=62G
#SBATCH --output=jobname_%J_stdoutsigmoidtria3updatedtrial16.txt
#SBATCH --error=jobname_%J_stderrsigmoidtria3updatedtrial16.txt
...
python $HOME/sigmoidtria3updatedtrial16.py
