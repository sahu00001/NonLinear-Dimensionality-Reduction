...
encoding_dim = 103  # Manually setting the encoding dimension
encoder_neurons = [859,1935, 1234, 652]  # Encoder: decreasing number of neurons
decoder_neurons = [758,2287]  # Decoder: increasing number of neurons
epochs = 5000  # Number of epochs
batch_size = 63  # Batch size
learning_rate = 0.000011998847693141358  # Custom learning rate
...
autoencoder.save("tanhtrial3updatedtrial33.h5")
...
# Save metrics to CSV
output_csv_file = 'tanhtrial3updatedtrial33.csv'
