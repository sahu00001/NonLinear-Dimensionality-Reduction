...
encoder_neurons = [343]  # Encoder: decreasing number of neurons
decoder_neurons = [1544, 185]  # Decoder: increasing number of neurons
epochs = 5000  # Number of epochs
batch_size = 97  # Batch size
learning_rate = 0.000046003163448841294  # Custom learning rate
...
autoencoder.save("tanhtrial1updatedtrial25.h5")
...
# Save metrics to CSV
output_csv_file = 'tanhtrial1updatedtrial25.csv'
