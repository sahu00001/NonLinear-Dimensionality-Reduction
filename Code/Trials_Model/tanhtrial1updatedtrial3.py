...
encoding_dim = 132  # Manually setting the encoding dimension
encoder_neurons = [1538, 631, 2066]  # Encoder: decreasing number of neurons
decoder_neurons = [1633, 1480]  # Decoder: increasing number of neurons
epochs = 5000  # Number of epochs
batch_size = 29  # Batch size
learning_rate = 0.022357314954380984  # Custom learning rate
...
autoencoder.save("tanhtrial1updatedtrial3.h5")
...
# Save metrics to CSV
output_csv_file = 'tanhtrial1updatedtrial3.csv'
