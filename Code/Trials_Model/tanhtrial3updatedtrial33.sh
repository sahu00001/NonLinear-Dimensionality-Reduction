...
#SBATCH --ntasks=1
#SBATCH --mem=62G
#SBATCH --output=jobname_%J_stdouttanhtrial3updatedtrial33.txt
#SBATCH --error=jobname_%J_stderrtanhtrial3updatedtrial33.txt
...
python $HOME/tanhtrial3updatedtrial33.py
