...
encoding_dim = 122  # Manually setting the encoding dimension
encoder_neurons = [515, 1896, 2059]  # Encoder: decreasing number of neurons
decoder_neurons = [1478,2107]  # Decoder: increasing number of neurons
epochs = 5000  # Number of epochs
batch_size = 51  # Batch size
learning_rate = 0.000012903742214339437  # Custom learning rate
...
autoencoder.save("sigmoidtria1updatedtrial15.h5")
...
# Save metrics to CSV
output_csv_file = 'sigmoidtria1updatedtrial15.csv'
