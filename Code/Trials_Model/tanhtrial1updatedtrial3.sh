...
#SBATCH --ntasks=1
#SBATCH --mem=62G
#SBATCH --output=jobname_%J_stdouttanhtrial1updatedtrial3.txt
#SBATCH --error=jobname_%J_stderrtanhtrial1updatedtrial3.txt
...
python $HOME/tanhtrial1updatedtrial3.py
