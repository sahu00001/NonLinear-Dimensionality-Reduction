...
#SBATCH --ntasks=1
#SBATCH --mem=62G
#SBATCH --output=jobname_%J_stdoutsigmoidtria3updatedtrial79.txt
#SBATCH --error=jobname_%J_stderrsigmoidtria3updatedtrial79.txt
...
python $HOME/sigmoidtria3updatedtrial79.py
