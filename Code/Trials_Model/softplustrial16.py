...
encoding_dim = 86  # Manually setting the encoding dimension
encoder_neurons = [916]  # Encoder: decreasing number of neurons
decoder_neurons = [2231, 557, 1804, 216]  # Decoder: increasing number of neurons
epochs = 5000  # Number of epochs
batch_size = 83  # Batch size
learning_rate = 0.00003220911589315107  # Custom learning rate
...
autoencoder.save("softplustrial16.h5")
...
# Save metrics to CSV
output_csv_file = 'softplustrial16.csv'
