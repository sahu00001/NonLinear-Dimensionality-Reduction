...
encoding_dim = 90  # Manually setting the encoding dimension
encoder_neurons = [1675]  # Encoder: decreasing number of neurons
decoder_neurons = [2013]  # Decoder: increasing number of neurons
epochs = 5000  # Number of epochs
batch_size = 91  # Batch size
learning_rate = 0.00002149535802738748  # Custom learning rate
...
autoencoder.save("sigmoidtria3updatedtrial16.h5")
...
# Save metrics to CSV
output_csv_file = 'sigmoidtria3updatedtrial16.csv'
