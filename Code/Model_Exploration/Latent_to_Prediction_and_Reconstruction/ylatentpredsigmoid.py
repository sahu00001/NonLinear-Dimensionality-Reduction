...
autoencoder = tf.keras.models.load_model("sigmoidtria3updatedtrial79.h5", custom_objects={ 'custom_sigmoid': Activation(custom_sigmoid),'mse': mse,'rmse': rmse,'r_squared': r_squared,})
...
latent_file_path = "NACCS_sigmoid79for3000locations.mat"
...
if y_hat_latent_transposed.shape[1] != 101:
...
reconstructed_output_path = "reconstructed_y_hat_sigmoidtria3updatedtrial79.csv"
