...
# Define the custom shifted Softplus activation function
...
def create_autoencoder(input_dim, encoding_dim, encoder_neurons, decoder_neurons, learning_rate, optimizer_choice):
    ...
    for neuron in encoder_neurons:
        x = Dense(
            neuron,
            activation=shifted_softplus  # Use shifted Softplus
        )(x)
...
df_trials.to_csv('shifted_softplus_trialupdated.csv', index=False)
